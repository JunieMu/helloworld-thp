...
CREATE TABLE public.speedbump_answer_events (
  id bigint GENERATED ALWAYS AS IDENTITY NOT NULL,
  profile_id uuid NOT NULL,
  ...
  presented_order_index smallint NOT NULL CHECK (presented_order_index >= 0 AND presented_order_index <= 3),
  client_event_id uuid NOT NULL UNIQUE,
  session_id uuid,
  created_datetime_utc timestamp with time zone NOT NULL DEFAULT now(),
  created_by_user_id uuid NOT NULL DEFAULT auth.uid(),
  CONSTRAINT speedbump_answer_events_pkey PRIMARY KEY (id),
  CONSTRAINT speedbump_answer_events_profile_id_fkey FOREIGN KEY (profile_id) REFERENCES public.profiles(id),
  CONSTRAINT speedbump_answer_events_question_id_fkey FOREIGN KEY (question_id) REFERENCES public.speedbump_questions(id),
  CONSTRAINT speedbump_answer_events_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.profiles(id),
  CONSTRAINT speedbump_answer_events_question_answer_fkey FOREIGN KEY (question_id) REFERENCES public.speedbump_answers(id),
  CONSTRAINT speedbump_answer_events_question_answer_fkey FOREIGN KEY (question_id) REFERENCES public.speedbump_answers(question_id),
  CONSTRAINT speedbump_answer_events_question_answer_fkey FOREIGN KEY (answer_id) REFERENCES public.speedbump_answers(id),
  CONSTRAINT speedbump_answer_events_question_answer_fkey FOREIGN KEY (answer_id) REFERENCES public.speedbump_answers(question_id)
);
CREATE TABLE public.speedbump_answers (
  id bigint GENERATED ALWAYS AS IDENTITY NOT NULL,
  question_id text NOT NULL,
  ...
  created_datetime_utc timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT speedbump_answers_pkey PRIMARY KEY (id),
  CONSTRAINT speedbump_answers_question_id_fkey FOREIGN KEY (question_id) REFERENCES public.speedbump_questions(id)
);
CREATE TABLE public.speedbump_questions (
  id text NOT NULL,
  prompt text NOT NULL,
  sort_order integer NOT NULL UNIQUE,
  created_datetime_utc timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT speedbump_questions_pkey PRIMARY KEY (id)
);
...
CREATE TABLE public.study_caption_navigation_events (
  id bigint GENERATED ALWAYS AS IDENTITY NOT NULL,
  profile_id uuid NOT NULL,
  caption_id uuid NOT NULL,
  study_caption_mapping_id bigint,
  time_to_next_caption_ms integer NOT NULL CHECK (time_to_next_caption_ms >= 0),
  input_method USER-DEFINED NOT NULL,
  client_event_id uuid NOT NULL UNIQUE,
  session_id uuid,
  created_datetime_utc timestamp with time zone NOT NULL DEFAULT now(),
  created_by_user_id uuid NOT NULL DEFAULT auth.uid(),
  CONSTRAINT study_caption_navigation_events_pkey PRIMARY KEY (id),
  CONSTRAINT study_caption_navigation_events_profile_id_fkey FOREIGN KEY (profile_id) REFERENCES public.profiles(id),
  CONSTRAINT study_caption_navigation_events_caption_id_fkey FOREIGN KEY (caption_id) REFERENCES public.captions(id),
  CONSTRAINT study_caption_navigation_events_study_caption_mapping_id_fkey FOREIGN KEY (study_caption_mapping_id) REFERENCES public.study_caption_mappings(id),
  CONSTRAINT study_caption_navigation_events_created_by_user_id_fkey FOREIGN KEY (created_by_user_id) REFERENCES public.profiles(id)
);
